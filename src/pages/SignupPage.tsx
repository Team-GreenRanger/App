      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 space-y-8">
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <button
            ...
            className="w-full bg-green-500 text-white py-4 rounded-full text-lg font-medium hover:bg-green-600 transition-colors mt-8"
          >
            Sign up
          </button>
          ...
          <button
            ...
            className="w-full border border-gray-300 py-4 rounded-lg flex items-center justify-center space-x-2 hover:bg-gray-50 transition-colors"
          >
